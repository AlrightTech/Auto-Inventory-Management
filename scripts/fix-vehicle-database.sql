-- Database Update Script for Vehicle Creation Fix
-- Run this in your Supabase SQL Editor to fix the vehicle creation issue
...
-- Update arb_status enum to match TypeScript interface (if it exists)
ALTER TABLE vehicles 
